...
public class MapGenerator : MonoBehaviour {
    ...
    //public const int mapChunkSize = 95; // 239 + 2 (for border in mesh generation) = 241
    ...
    struct MapThreadInfo<T> {
        ...
        public MapThreadInfo (Action<T> newCallback, T newParameter) {
...
public struct MapData {
    ...
    public MapData (float[,] newHeightMap, Color[] newColourMap) {
